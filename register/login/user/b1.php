  ...
  <body>
	...
	<div id="colorlib-page" >
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="index.html"><span class="img" style="background-image: url(images/author.jpg);"></span><?php session_start(); echo $_SESSION['login_user']?></a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li class="colorlib-active"><a href="index.php">Home</a></li>
					<li><a href="vrl/note/index.html">My notes</a></li>
					
					<li><a href="vrl/logi/index.html">public space</a></li>
                    <li><a href="comp/compiler.php">practice space</a></li>
                    <li><a href="/eclipse/">Log out</a></li>
					
				</ul>
			</nav>

			<div class="colorlib-footer" style="background-color: black">
				...
				<div class="hero-wrap">
					...
					<div class="d-flex align-items-center js-fullheight">
						<div class="author-image text img d-flex">
					      ...
					      <div class="slider-item js-fullheight" style="background-image: url(images/fr.jpg)   ;">
					      </div>
                            </section>
						</div>
                            <div class="author-info text p-3 p-md-5">
						<div class="desc">
								<span class="subheading">Step 1</span>
								<h1 class="big-letter">Loops</h1>
								<h1 class="mb-4"><span>Looping structures</span>.</h1>
								<p class="mb-4">Loop structures allow you to run one or more lines of code repetitively. You can repeat the statements in a loop structure until a condition is True, until a condition is False, a specified number of times, or once for each element in a collection.
The following illustration shows a loop structure that runs a set of statements until a condition becomes true.</p>
			...
			<section class="ftco-section instagram">
                <div class="container"><a href=b2.php><input type="button" value="Next" /></a>
					
                    <span style="align-content: flex-end"><a href=index.php><input type="button" value="Prev" /></a>
