				...
				<div class="hero-wrap">
					...
					<div class="d-flex align-items-center js-fullheight">
						<div class="author-image text img d-flex">
					      ...
					      <div class="slider-item js-fullheight" style="background-image: url(images/variable-1.png);">
					      </div>
                            </section>
						</div>
                            <div class="author-info text p-3 p-md-5">
						<div class="desc">
								<span class="subheading">Step 3</span>
								<h1 class="big-letter">Variables</h1>
								<h1 class="mb-4"><span>Variable Declaration</span>.</h1>
								<p class="mb-4">A variable or scalar is a storage location paired with an associated symbolic name, which contains some known or unknown quantity of information referred to as a value. The variable name is the usual way to reference the stored value. Variables are the backbone of any program, and thus the backbone of any programming language.in simple terms, a variable is simply a way to store some sort of information for later use, and we can retrieve this information by referring to a “word” that will describe this information.
                                 <br>   <span style="color: black; text-decoration: underline"> Different types of variables include:</span><br>

<span style="color: black">Integer</span> – to store integer or “whole” numbers<br>
                                    <span style="color: black">Character</span> – A single character such as a letter of the alphabet or punctuation.<br>
                                    <span style="color: black">String </span>– A collection of characters
			...
			<section class="ftco-section instagram">
                <div class="container"><a href=b4.php><input type="button" value="Next" /></a>
					 <span style="align-content: flex-end"><a href=b2.php><input type="button" value="Prev" /></a>
