				...
				<div class="hero-wrap">
					...
					<div class="d-flex align-items-center js-fullheight">
						<div class="author-image text img d-flex">
					      ...
					      <div class="slider-item js-fullheight" style="background-image: url(images/syntax.png);">
					      </div>
                            </section>
						</div>
                            <div class="author-info text p-3 p-md-5">
						<div class="desc">
								<span class="subheading">Step 4</span>
								<h1 class="big-letter">Syntax</h1>
								<h1 class="mb-4"><span>Syntax</span>.</h1>
								<p class="mb-4">In computer science, the syntax of a programming language is the set of rules that define the combinations of symbols that are considered to be correctly structured programs in that language. Documents that are syntactically invalid are said to have a syntax error. The concept of syntax in programming language is similar to the concepts of grammar and spelling in spoken language.
                                 <br>   <span style="color: black; text-decoration: underline"> Computer language syntax is generally distinguished into three levels:</span><br>

<span style="color: black">Words </span> –  the lexical level, determining how characters form tokens;<br>
                                    <span style="color: black">Phrases</span> –  the grammar level, narrowly speaking, determining how tokens form phrases;<br>
                                    <span style="color: black">Context </span>–  determining what objects or variables names refer to, if types are valid, etc.
			...
			<section class="ftco-section instagram">
                <div class="container">
					 <span style="align-content: flex-end"><a href=b3.php><input type="button" value="Prev" /></a>
