	...
	<div id="colorlib-page" >
		...
		<div id="colorlib-main" >
				...
				<div class="hero-wrap">
					...
					<div class="d-flex align-items-center js-fullheight">
						<div class="author-image text img d-flex">
					      ...
					      <div class="slider-item js-fullheight" style="background-image: url(images/control.png);">
					      </div>
                            </section>
						</div>
                            <div class="author-info text p-3 p-md-5">
						<div class="desc">
								<span class="subheading">Step 2</span>
								<h1 class="big-letter">Controlling</h1>
								<h1 class="mb-4"><span>Control structures</span>.</h1>
                           ...
                           When a program is running, the code is being read by the computer line by line (from top to bottom, and for the most part left to right), just like you would read a book. .</p>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="ftco-section instagram">
                <div class="container"><a href=b3.php><input type="button" value="Next" /></a>
					 <span style="align-content: flex-end"><a href=b1.php><input type="button" value="Prev" /></a>
